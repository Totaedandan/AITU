...
class Game:
    ...
    def run_game_loop(self, level_speed):
        ...
        player_character = PlayerCharacter('png-clipart-chicken-breast-jerky-app-store-ranking-cartoon-rice-animals-chicken-meat.png', 390, 600, 50, 50)
        enemy_0 = EnemyCharacter('138-1380109_2d-car-hd-png-download.png', 730, 530, 50, 50)
        # Speed increased as we advance in difficulty
        enemy_0.SPEED *= level_speed

        # Create another enemy
        enemy_1 = EnemyCharacter('138-1380109_2d-car-hd-png-download.png', self.width - 40, 400, 50, 50)
        enemy_1.SPEED *= level_speed

        # Create another enemy
        enemy_2 = EnemyCharacter('138-1380109_2d-car-hd-png-download.png', 20, 200, 50, 50)
        enemy_2.SPEED *= level_speed

        treasure = GameObject('png-transparent-basket-basket-wicker-nyseglw-storage-basket-material-thumbnail.png', 390, 50, 50, 50)
...
new_game = Game('background-1_0.png', SCREEN_TITLE, SCREEN_WIDTH, SCREEN_HEIGHT)
...
# Draw the player image on top of the screen a